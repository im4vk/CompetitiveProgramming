...
public class BarChart {
    ...
    private static Color[] initColors() {
        ...
        String[] hex12 = { "#80b1d3", "#fdb462", "#b3de69", "#fccde5", "#8dd3c7", "#ffffb3", "#bebada", "#fb8072",
                "#d9d9d9", "#bc80bd", "#ccebc5", "#ffed6f" };

        // 20 colors from https://vega.github.io/vega/docs/schemes/
        // replaced #d62728 with #d64c4c
        String[] hex20 = { "#aec7e8", "#c5b0d5", "#c49c94", "#dbdb8d", "#17becf", "#9edae5", "#f7b6d2", "#c7c7c7",
                "#1f77b4", "#ff7f0e", "#ffbb78", "#98df8a", "#d64c4c", "#2ca02c", "#9467bd", "#8c564b", "#ff9896",
     ...
     * automatially). This method is useful if you know that the values stay within
     * a given range.
     *
    ...
    /**
     * Sets the caption of this bar chart. The caption is drawn in the lower-right
     * part of the window.
     *
     ...
     * value. The bars are drawn from top to bottom in the order they are added. All
     * bars from the same category are drawn with the same color.
     *
    ...
    /**
     * Removes all of the bars from this bar chart (but keep the color scheme). This
     * method is convenient when drawing an animated bar chart.
     */
    public void reset() {
